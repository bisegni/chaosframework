...
private:
    ...
    std::string basePath;
    int id;
    caching_system::caching_thread::FetcherDeviceTracker<Magnete>* deviceTracker;
    
public:
    SimpleDataReader(IteratorReader<Magnete>* it, long fps,    std::string basePath,int id ,caching_system::caching_thread::FetcherDeviceTracker<Magnete>* deviceTracker){
