...
Q_DECLARE_METATYPE(chaos::metadata_service_client::node_monitor::OnlineStatus)
...
void MainController::init(int argc, char **argv, QApplication& a) {
    ...
    qRegisterMetaType<chaos::metadata_service_client::node_monitor::OnlineStatus>("chaos::metadata_service_client::node_monitor::OnlineStatus");
