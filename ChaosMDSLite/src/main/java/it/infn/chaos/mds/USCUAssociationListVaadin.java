...
public class USCUAssociationListVaadin extends CustomComponent {
	...
	private HorizontalLayout buildHorizontalLayout_6() {
		...
		buttonSwapAutoLoad.setImmediate(false);
	...
	private HorizontalLayout buildHorizontalLayout_2() {
		...
		buttonSaveAttributeConfig.setCaption("Save");
		buttonSaveAttributeConfig.setImmediate(true);
		buttonSaveAttributeConfig.setWidth("-1px");
		...
		buttonAddAttributeConfig.setImmediate(false);
		...
		buttonRemoveAttributeConfig.setWidth("-1px");
