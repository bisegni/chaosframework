 ...
 */
#ifndef __CHAOSFramework__ConsumerMDSApi__
#define __CHAOSFramework__ConsumerMDSApi__
	...
	namespace wan_proxy {
		namespace api {
			namespace producer {
				...
				class ConsumerMDSApi:
				public AbstractApi {
				public:
					//! default constructor
					ConsumerMDSApi(persistence::AbstractPersistenceDriver *_persistence_driver);
...
#endif /* defined(__CHAOSFramework__ConsumerMDSApi__) */
