 ...
 */
#ifndef __CHAOSFramework__GrafanaAnnotations__
#define __CHAOSFramework__GrafanaAnnotations__
		...
		namespace api {
            namespace grafana {
				...
				public:
					...
					//! default constructor
					GrafanaAnnotations(persistence::AbstractPersistenceDriver *_persistence_driver);
...
#endif /* defined(__CHAOSFramework__GrafanaAnnotations__) */
