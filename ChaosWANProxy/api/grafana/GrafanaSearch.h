 ...
 */
#ifndef __CHAOSFramework__GrafanaSearch__
#define __CHAOSFramework__GrafanaSearch__
		...
		namespace api {
            namespace grafana {
				...
				public:
					...
					//! default constructor
					GrafanaSearch(persistence::AbstractPersistenceDriver *_persistence_driver);
...
#endif /* defined(__CHAOSFramework__GrafanaSearch__) */
