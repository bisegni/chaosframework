 ...
 */
#ifndef __CHAOSFramework__GrafanaQuery__
#define __CHAOSFramework__GrafanaQuery__
		...
		namespace api {
            namespace grafana {
				...
				public:
					...
					//! default constructor
					GrafanaQuery(persistence::AbstractPersistenceDriver *_persistence_driver);
...
#endif /* defined(__CHAOSFramework__GrafanaQuery__) */
