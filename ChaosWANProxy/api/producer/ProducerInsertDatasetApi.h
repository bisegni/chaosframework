	...
	namespace wan_proxy {
		namespace api {
			namespace producer {
				...
				class ProducerInsertDatasetApi:
				public AbstractApi {
				public:
					//! default constructor
					ProducerInsertDatasetApi(persistence::AbstractPersistenceDriver *_persistence_driver);
...
#endif /* defined(__CHAOSFramework__ProducerInsertDatasetApi__) */
