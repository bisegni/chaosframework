...
int StageDataVFileScanner::processDataPack(const bson::BSONObj& data_pack,
	...
	if(!data_pack.hasField(chaos::DataPackCommonKey::DPCK_DEVICE_ID) ||
	   ...
	   !data_pack.hasField(chaos::DataPackCommonKey::DPCK_DATASET_TYPE) ) {
	...
	new_data_pack_index.pack_type = data_pack.getField(chaos::DataPackCommonKey::DPCK_DATASET_TYPE).numberInt();
