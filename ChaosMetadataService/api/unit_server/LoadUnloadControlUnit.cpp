...
CDataWrapper *LoadUnloadControlUnit::execute(CDataWrapper *api_data,
    ...
    std::unique_ptr<CDataWrapper> load_unload_data_pack(new CDataWrapper());
    ...
    if((err = n_da->getNodeDescription(cu_uid, &cu_base_descirption))){
        ...
        std::unique_ptr<CDataWrapper> cu_inf(cu_base_descirption);
        ...
        if((err = cu_da->getInstanceDescription(cu_uid,
           ...
           (cu_instance_description == NULL)) {
            ...
            std::unique_ptr<CDataWrapper> cu_instance(cu_instance_description);
            ...
            std::unique_ptr<CDataWrapper> us_instance(us_base_description);
