...
#include <stdio.h>
#include <cassert>
#include "ObjectQueueTest.h"

using namespace chaos::common::pqueue::test;
ObjectQueueTest::ObjectQueueTest():
...
bool ObjectQueueTest::test(int _number_of_producer,
    ...
    for(int idx = 0;idx < number_of_producer; idx++) {
        tg.add_thread(new boost::thread(boost::bind(&ObjectQueueTest::producer,
                                                    this)));
    }
