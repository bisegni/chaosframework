...
QMAKE    = /usr/bin/qmake
testui.xcodeproj/project.pbxproj: UIToolkitTest.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o testui.xcodeproj/project.pbxproj UIToolkitTest.pro
