...
ControlUnitController::ControlUnitController(const std::string &_node_uid)
    ...
    cu_output_ds_key(
        boost::str(boost::format("%1%2") % getNodeUID() % chaos::DataPackPrefixID::OUTPUT_DATASE_PREFIX)),
    cu_input_ds_key(
        boost::str(boost::format("%1%2") % getNodeUID() % chaos::DataPackPrefixID::INPUT_DATASE_PREFIX)),
    cu_system_ds_key(
        boost::str(boost::format("%1%2") % getNodeUID() % chaos::DataPackPrefixID::SYSTEM_DATASE_PREFIX)) {
