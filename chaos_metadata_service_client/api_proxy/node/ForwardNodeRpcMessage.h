        ...
        namespace api_proxy {
            namespace node {
                ...
                public chaos::metadata_service_client::api_proxy::ApiProxy {
                    API_PROXY_CLASS(ForwardNodeRpcMessage)
                protected:
                    //! default constructor
                    API_PROXY_CD_DECLARATION(ForwardNodeRpcMessage)
                public:
                    /*!
                    ...
                    ApiProxyResult execute(const std::string& node_uid,
                                           ...
                                           const chaos::common::data::CDWUniquePtr& message_data = chaos::common::data::CDWUniquePtr());
                };
            }
        }
    }
