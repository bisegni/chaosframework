...
void
ScriptableExecutionUnit::registerApi() {
...
void
ScriptableExecutionUnit::unregisterApi() {
    CHAOS_ASSERT(script_manager().get());
...
void
ScriptableExecutionUnit::unitDefineActionAndDataset() throw(CException) {
    int err = 0;
    bool exists = false;
...
void
ScriptableExecutionUnit::executeAlgorithmLaunch() throw(CException) {
...
void
ScriptableExecutionUnit::executeAlgorithmStart() throw(CException) {
...
void
ScriptableExecutionUnit::executeAlgorithmStep(uint64_t step_delay_time) throw(CException) {
...
void
ScriptableExecutionUnit::executeAlgorithmStop() throw(CException) {
...
void
ScriptableExecutionUnit::executeAlgorithmEnd() throw(CException) {
...
void
ScriptableExecutionUnit::unitUndefineActionAndDataset() throw(CException) {
...
bool
ScriptableExecutionUnit::updatedInputDataset(const std::string &attribute_name,
...
CDataWrapper *
ScriptableExecutionUnit::updateScriptSource(CDataWrapper *data_pack,
