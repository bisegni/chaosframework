            ...
            namespace driver {
                ...
                protected CDWShrdPtrFutureHelper {
                    ...
                    void driverInit(const char *initParameter) throw (chaos::CException) {
                        ...
                        chaos::common::external_unit::ExternalUnitServerEndpoint::endpoint_identifier = jv_endpoint_name.asString();
                    ...
                    void driverInit(const chaos::common::data::CDataWrapper& init_parameter) throw(chaos::CException) {
                        ...
                        //! end point identifier & authorization key
                        chaos::common::external_unit::ExternalUnitServerEndpoint::endpoint_identifier = init_parameter.getStringValue("endpoint_name");
                    ...
                    int sendRawRequest(chaos::common::data::CDWUniquePtr message_data,
                        ...
                        chaos::common::external_unit::ExternalUnitServerEndpoint::sendMessage(current_connection_identifier(),
                ...
                protected:
                    ...
                    int sendError(int error_code,
                        ...
                        chaos::common::external_unit::ExternalUnitServerEndpoint::sendError(current_connection_identifier(),
                            ...
                            if(message->hasKey(AUTHORIZATION_KEY) &&
                               message->isStringValue(AUTHORIZATION_KEY)) {
                                if(authorization_key.compare(message->getStringValue(AUTHORIZATION_KEY)) == 0){
                                    ...
                                    chaos::common::external_unit::ExternalUnitServerEndpoint::sendError(connection_identifier,
                                                                                                        -1, "Authentication failed", __PRETTY_FUNCTION__);
                                    chaos::common::external_unit::ExternalUnitServerEndpoint::closeConnection(connection_identifier);
                                }
                            }
                        } else {
