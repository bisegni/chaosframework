...
namespace chaos {
    ...
    protected:
        void *zmq_context;
        virtual void processBufferElement(NFIUniquePtr element) throw(CException);
    ...
    public:
         ...
         */
        bool submitMessage(NFIUniquePtr forwardInfo, bool onThisThread=false) throw(CException);
