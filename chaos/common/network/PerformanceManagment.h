...
namespace chaos {
	...
	namespace common {
		...
		namespace network {
			...
			protected ::chaos::utility::TemplatedKeyObjectContainer<std::string, chaos_direct_io::DirectIOPerformanceLoop*> {
				...
				boost::lockfree::queue<chaos_direct_io::DirectIOPerformanceLoop*, boost::lockfree::fixed_sized<false> > queue_purgeable_performance_node;
				
				PerformanceManagment(NetworkBroker *_network_broker);
				~PerformanceManagment();
				
				void  disposePerformanceNode(chaos_direct_io::DirectIOPerformanceLoop *performance_node);
			...
			protected:
				...
				void freeObject(std::string server_description, chaos_direct_io::DirectIOPerformanceLoop *performance_node);
