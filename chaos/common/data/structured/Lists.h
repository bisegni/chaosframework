        ...
        namespace data {
            namespace structured {
                ...
                public:
                    ...
                    StdVectorSDWrapper(std::unique_ptr< DataWrapperReference< std::vector<T> > > _data = std::unique_ptr< DataWrapperReference< std::vector<T> > >(new DataWrapperCopy< std::vector<T> >())):
