...
#include <chaos/common/extension/common.hpp>
#include <chaos/common/extension/impl/library_impl.hpp>
...
#define BOOST_PP_FILENAME_1 <chaos/common/extension/impl/shared_library.hpp>
