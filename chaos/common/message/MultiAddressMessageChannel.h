    ...
    namespace common {
        ...
        namespace message {
            ...
            private chaos::common::network::URLHAServiceCheckerFeederHandler {
                 ...
                 */
                std::unique_ptr<MessageRequestFuture> _sendRequestWithFuture(const std::string& action_domain,
            ...
            public:
                ...
                /*!
                 ...
                 \return the future of the request or null if no server has been found
                 */
                std::unique_ptr<MultiAddressMessageRequestFuture> sendRequestWithFuture(const std::string& action_domain,
                                                                                      const std::string& action_name,
                                                                                      chaos::common::data::CDataWrapper *request_pack,
