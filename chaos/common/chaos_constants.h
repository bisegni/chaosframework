    ...
    namespace common {
        namespace event {
            ...
            namespace EventConfiguration {
                ...
                static const char * const   CONF_EVENT_ALERT_MADDRESS                   = "127.255.0.1";
                //! @Configuration for instruments event multicast ip
                static const char * const   CONF_EVENT_INSTRUMENT_MADDRESS              = "127.255.0.2";
                //! @Configuration for command event multicast ip
                static const char * const   CONF_EVENT_COMMAND_MADDRESS                 = "127.255.0.3";
                //! @Configuration for custom event multicast ip
                static const char * const   CONF_EVENT_CUSTOM_MADDRESS                  = "127.255.0.4";
