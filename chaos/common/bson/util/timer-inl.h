...
#include <chaos/common/chaos/util/timer-win32-inl.h>
...
// use those.
#include <chaos/common/chaos/util/timer-posixclock-inl.h>

#else

// If all else fails, fall back to a generic implementation.  Performance may suffer.
#include <chaos/common/bson/util/timer-generic-inl.h>
