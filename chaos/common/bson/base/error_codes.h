...
// See src/bson/base/generate_error_codes.py
...
namespace bson {
     ...
     * strings. The class is derived from the definitions in src/bson/base/error_codes.err file.
     *
     * Do not update this file directly. Update src/bson/base/error_codes.err instead.
     */
