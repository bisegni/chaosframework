...
#if defined(_WIN32)
#include <chaos/common/bson/platform/atomic_intrinsics_win32.h>
#elif defined(__GNUC__)
#if defined(__i386__) || defined(__x86_64__)
#include <chaos/common/bson/platform/atomic_intrinsics_gcc_intel.h>
#else
#include <chaos/common/bson/platform/atomic_intrinsics_gcc_generic.h>
#endif
#else
