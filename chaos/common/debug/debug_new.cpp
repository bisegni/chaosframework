...
#endif
#include <chaos/common/debug/_nvwa.h>              // NVWA_NAMESPACE_*
#include <chaos/common/debug/c++11.h>              // _NOEXCEPT
#include <chaos/common/debug/fast_mutex.h>         // nvwa::fast_mutex
#include <chaos/common/debug/static_assert.h>      // STATIC_ASSERT
...
#define _DEBUG_NEW_PROGNAME "CHAOS_CONTROL_SYSTEM"
#endif
 ...
 *              insufficient
 */
void* operator new(size_t size, const std::nothrow_t& ex, const char* file, int line) _NOEXCEPT
{
