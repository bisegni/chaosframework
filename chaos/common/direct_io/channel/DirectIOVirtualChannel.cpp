...
DirectIOVirtualChannel::DirectIOVirtualChannel(std::string _channel_name,
                                               uint8_t __channel_route_index):
NamedService(_channel_name),
channel_route_index(__channel_route_index) {}
