...
public class MainView extends CustomComponent {
	...
	/**
	 * @param buttonRefresh the buttonRefresh to set
	 */
	...
	private VerticalLayout buildDeviceVerticalLayout() {
		...
		deviceVerticalLayout.setMargin(false);
	...
	private VerticalLayout buildDatasetsVerticalLayout() {
		...
		datasetsVerticalLayout.setWidth("100.0%");
		datasetsVerticalLayout.setHeight("100.0%");
		datasetsVerticalLayout.setMargin(false);
